                            ...
                            <table id="itemTable" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="width12percent">
                                        <input type="text" data-column="11" id="dayFrom" placeholder="from"  class="search-input-date form-control width100percent">
                                        <input type="text" data-column="12" id="dayTo" placeholder="to" class="search-input-date form-control width100percent">
                                    </td>
